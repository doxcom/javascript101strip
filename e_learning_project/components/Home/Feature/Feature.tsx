     ...
     <div className="flex items-center space-x-4">
          ...
          <div className="mt-8 mb-6">
           ...
           <p className="text-sm md:text-base text-black text-opacity-70 mt-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque voluptatibus obcaecati assumenda itaque sit, rerum consequatur commodi nemo cupiditate. Mollitia corrupti tempora quisquam veritatis sed ullam necessitatibus cumque recusandae doloribus!
           </p>
          </div>
